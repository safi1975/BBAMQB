...
public class ClientController {
  ...
  public String saveMulti(Model model,
                          @Valid @ModelAttribute(name = "clientsDto")
                          ClientsDto clientsDto, BindingResult result,
    ...
    if (isOperator()) {
      ...
      redirectAttributes.addFlashAttribute("notyfyMsg",
                                           "Clients added: " + count);
      return "redirect:/";
    }
  ...
  public String
      save(Model model,
           @Valid @ModelAttribute(name = "client") ClientDto clientDto,
