...
public class SmsServiceImpl implements SmsService {
	...
	public String sendSms(String phone, String code) {
		String url = "http://vas.mobilogi.com/api.php?username=bbamqb&password=D4rkh0lme&route=1&sender=NUVANT&mobile[]="+ phone + "&message[]= OTP to login to Data Entry Portal is + code +. NUVANTECH&templateid=1707171644837732653";
