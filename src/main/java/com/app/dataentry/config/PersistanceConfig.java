...
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactory",
                       basePackages = {"com.app.dataentry.repositories"},
...
public class PersistanceConfig {
  ...
  @Value("${datasource.minPoolSize}") private int minPoolSize;
  @Value("${datasource.maxPoolSize}") private int maxPoolSize;
  @Value("${datasource.maxIdleTime}") private int maxIdleTime;
  ...
  entityManagerFactory(EntityManagerFactoryBuilder builder,
    ...
    return builder.dataSource(dataSource)
        .packages("com.app.dataentry.model")
        .persistenceUnit("app")
        .build();
  }
